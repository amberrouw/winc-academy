...
let person = {name:"Amber", age:27, evaluations:[7, 10, 9]};
console.log(person);
console.log(person.name); //logs Amber
console.log(person.age);  //logs 27
console.log(person.evaluations); //logs [ 7, 10, 9 ]
